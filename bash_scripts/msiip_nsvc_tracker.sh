...
for it in $(seq 0 $[${2}-1])
do
  python ../scripts/dstc_thu/msiip_nsvc_tracker.py --dataset dstc4_dev --dataroot ../data/ --model_dir ../output/models/NSVC_models/nsvc_${1}_model_boost/${it}/ --trackfile ../output/msiip_out/msiip_nsvc_out/msiip_nsvc_${1}_boost${it}_t80_hr.json --ontology ../scripts/config/ontology_dstc4.json
